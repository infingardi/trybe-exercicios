...
// exercicio 2
const somaNumeros = (...args) => args.reduce((acc, num) => acc + num);

console.log(somaNumeros(12, 8, 7, 20));
...
const filterPeople = () => {
    const australinaPeople = people.filter(({ bornIn, nationality }) => bornIn >= 1901 && bornIn <= 2000 && nationality === 'Australian');

    return australinaPeople;
}
